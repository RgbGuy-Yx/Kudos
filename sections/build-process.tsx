...
const leftSteps: Step[] = [
    {
        title: "Sponsor Creates Grant Contract",
        description:
            "Sponsor defines student wallet, total amount, and milestone count to initialize a transparent grant lifecycle.",
    },
    {
        title: "Student Submits Milestone Proof",
        description:
            "Students submit proof links and delivery notes in the dashboard, creating evidence for sponsor verification.",
    },
];

const rightSteps: Step[] = [
    {
        title: "Escrow Gets Funded",
        description:
            "Sponsor funds are locked in escrow so disbursement can only happen through milestone approvals.",
    },
    {
        title: "Sponsor Approves Release",
        description:
            "After proof review, sponsor approves the milestone and contract state updates with controlled fund release.",
    },
];
    ...
    return (
        <section id="process" className="flex flex-col items-center mt-32">
            ...
            <h3 className="text-3xl max-w-sm text-gray-500 text-center mt-5">
                Run a complete grant cycle in four transparent steps
            </h3>
